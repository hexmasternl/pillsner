---
title: "Pillsner: Your partner in taking your pills"
description: "Pillsner is a native Android app that reminds you to take your medication on time and records whether you did, reliably and privately, on your device. No account, no cloud, no ads."
params:
  hero:
    eyebrow: "Never miss a dose again"
    heading: "Your partner in taking your pills"
    lead: "Pillsner reminds you the moment a dose is due and lets you confirm it in one tap, reliably, even when your phone is idle, without an account and without sending your data anywhere."
  why:
    heading: "Why Pillsner"
    intro: "Missing a dose, or taking one twice because you forgot you already did, is a common and frustrating problem. Most people do not want a full health platform for that. They want a small, trustworthy app that does exactly this and nothing more."
    points:
      - "Reminds you at the right moment, reliably, even when the phone is idle"
      - "Makes confirming a dose a one-tap action, right from the notification"
