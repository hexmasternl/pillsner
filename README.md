...
<p>
  <img src="docs/screens/home-upcoming-dose.png" width="200" alt="Home screen showing an upcoming dose due at 8:15 PM">
  <img src="docs/screens/dose-confirmation.png" width="200" alt="Dose confirmation screen with I took it, Not yet, and Not going to buttons">
  <img src="docs/screens/medicines-overview.png" width="200" alt="Medicines screen listing active and inactive medicines">
  <img src="docs/screens/settings.png" width="200" alt="Settings screen with language, theme, security and legal sections">
</p>
...
Pillsner is built through a spec-driven proposal → apply → archive workflow, with everything cut from a protected `development` branch. See [`CONTRIBUTING.md`](CONTRIBUTING.md) for prerequisites, the toolchain, how to build and run the app, and the full development and branching workflow.
