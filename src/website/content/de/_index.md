---
title: "Pillsner: Dein Partner bei der Einnahme deiner Medikamente"
description: "Pillsner ist eine native Android-App, die dich daran erinnert, deine Medikamente pünktlich einzunehmen, und festhält, ob du es getan hast, zuverlässig und privat, auf deinem Gerät. Kein Konto, keine Cloud, keine Werbung."
params:
  hero:
    eyebrow: "Verpasse nie wieder eine Einnahme"
    heading: "Dein Partner bei der Einnahme deiner Medikamente"
    lead: "Pillsner erinnert dich genau dann, wenn eine Einnahme fällig ist, und lässt dich sie mit einem Tipp bestätigen, zuverlässig, selbst wenn dein Handy im Ruhezustand ist, ohne Konto und ohne dass deine Daten irgendwohin gesendet werden."
  why:
    heading: "Warum Pillsner"
    intro: "Eine Einnahme zu verpassen, oder sie doppelt zu nehmen, weil man vergessen hat, sie bereits genommen zu haben, ist ein häufiges und frustrierendes Problem. Die meisten Menschen wollen dafür keine komplette Gesundheitsplattform. Sie wollen eine kleine, vertrauenswürdige App, die genau das tut und nichts weiter."
    points:
      - "Erinnert dich zum richtigen Zeitpunkt, zuverlässig, auch wenn das Handy im Ruhezustand ist"
      - "Macht das Bestätigen einer Einnahme zu einem einzigen Tipp, direkt aus der Benachrichtigung"
      - "Zeigt auf einen Blick, was heute noch fällig ist und was bereits genommen wurde"
