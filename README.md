...
**[Get it on Google Play](https://play.google.com/store/apps/details?id=nl.hexmaster.pillsner)** — free, no account required, available for Android 8.0 (API 26) and newer, with an optional companion app for compatible watches running API 26 and newer.
