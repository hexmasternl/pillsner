...
Thanks for your interest in Pillsner. This file covers everything you need to build, run and contribute to the project. For what the app does and why, see [README.md](README.md).
...
Pillsner needs permission to post notifications and to schedule exact alarms to behave correctly while you test it; grant both when prompted. The full list of permissions the app requests, and why, is in [README.md#permissions](README.md#permissions).
