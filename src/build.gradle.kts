...
plugins {
    ...
    // Declared here so the :shared module resolves one Kotlin version; AGP already carries the
    // Kotlin plugin on the classpath, and a version request in a subproject conflicts with it.
