---
title: "Pillsner: Tu compañero para tomar tus medicamentos"
description: "Pillsner es una aplicación Android nativa que te recuerda tomar tu medicación a tiempo y registra si lo hiciste, de forma fiable y privada, en tu dispositivo. Sin cuenta, sin nube, sin anuncios."
params:
  hero:
    eyebrow: "No vuelvas a olvidar una toma"
    heading: "Tu compañero para tomar tus medicamentos"
    lead: "Pillsner te avisa en el momento exacto en que toca una toma y te permite confirmarla con un solo toque, de forma fiable, incluso cuando el teléfono está inactivo, sin cuenta y sin enviar tus datos a ningún sitio."
  why:
    heading: "Por qué Pillsner"
    intro: "Olvidar una toma, o tomarla dos veces porque olvidaste que ya lo habías hecho, es un problema común y frustrante. La mayoría de las personas no quieren una plataforma de salud completa para esto. Quieren una app pequeña y fiable que haga exactamente esto, y nada más."
    points:
      - "Te avisa en el momento adecuado, de forma fiable, incluso con el teléfono inactivo"
      - "Convierte confirmar una toma en un solo toque, directamente desde la notificación"
      - "Muestra de un vistazo lo que falta por tomar hoy y lo que ya se tomó"
