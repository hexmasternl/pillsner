...
The editor SHALL offer exactly three patterns: "Every N days", "Weekdays" and "Every N hours". Switching pattern MUST keep the amount and MUST keep entered times where the new pattern uses a times list.
