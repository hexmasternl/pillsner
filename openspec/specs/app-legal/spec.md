...
Every string of both legal documents SHALL have an English and a Dutch version, and a missing or extra translation MUST fail the project's lint task. The publisher's name and the product name MUST NOT be translated.
...
- **WHEN** a legal string is added without a Dutch counterpart and lint runs
